...
//   uint16_t HW_X = (LCD_WIDTH - GUI_StrPixelWidth((uint8_t *)hardware))/2;
//   uint16_t FW_X = (LCD_WIDTH - GUI_StrPixelWidth((uint8_t *)firmware))/2;
...
// };
// const  uint32_t item_baudrate[ITEM_BAUDRATE_NUM] = {115200, 250000};
// static uint8_t  item_baudrate_i = 0;
...
//   for(uint8_t i=0; i<ITEM_BAUDRATE_NUM; i++)
//   {
